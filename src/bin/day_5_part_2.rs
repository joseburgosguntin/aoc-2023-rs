...
fn parse_seeds(i: &str) -> IResult<&str, Vec<(u64, u64)>> {
    delimited(
...
fn solution(s: &str) -> u64 {
    let (_, (seed_ranges, maps)) = tuple((parse_seeds, parse_maps))(s).unwrap();
    dbg!("got seed_ranges and maps");
